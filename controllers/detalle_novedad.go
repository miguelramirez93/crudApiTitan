...
// @router / [post]
func (c *DetalleNovedadController) Post() {
	var v models.DetalleNovedad
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddDetalleNovedad(&v); err == nil {
...
func (c *DetalleNovedadController) GetOne() {
	...
	v, err := models.GetDetalleNovedadById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
func (c *DetalleNovedadController) GetAll() {
	...
	l, err := models.GetAllDetalleNovedad(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *DetalleNovedadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.DetalleNovedad{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateDetalleNovedadById(&v); err == nil {
			c.Data["json"] = "OK"
		} else {
			c.Data["json"] = err.Error()
		}
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *DetalleNovedadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteDetalleNovedad(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
